...
.. image:: https://travis-ci.org/brack3t/Djrill.png?branch=v1.4
...
* Full documentation: https://djrill.readthedocs.org/en/v1.4/
...
See the `full documentation <https://djrill.readthedocs.org/en/v1.4/>`_
